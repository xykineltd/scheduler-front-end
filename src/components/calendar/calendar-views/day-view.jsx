...
const generateDaysInMonth = (date) => {
  ...
  const handlePrevDay = () => {
    ...
    console.log("Navigating to previous day:", newDate);
  ...
  const handleNextDay = () => {
    ...
    console.log("Navigating to next day:", newDate);
    setCurrentDate(newDate);
    setSelectedDate(newDate);
  };
        ...
        <div ref={container} className="flex flex-auto flex-col overflow-auto">
          ...
          <div className="flex w-full flex-auto">
            ...
            <div className="grid flex-auto grid-cols-1 grid-rows-1">
              ...
              >
                {/* Example Events - Replace with dynamic event rendering */}
                {/*
                {events
                  ...
                  .map((event) => (
                    <li
                      ...
                      style={{ gridRow: `${getGridRow(event.time)} / span 12` }}
                    >
                      <a
                ...
                */}
                ...
                >
                  <a
                    ...
                    onClick={() =>
                      handleEventClick({
                        title: "Sight Seeing at The Eiffel Tower",
                        time: "11:00 AM",
